  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .hero {
      ...
      overflow: hidden;
      background:
        radial-gradient(circle at top, rgba(255,43,43,.22), transparent 45%),
        linear-gradient(rgba(5,7,15,.78), rgba(5,7,15,.96)),
    ...
    .hero::before {
      ...
      position: absolute;
      inset: -50%;
      background: radial-gradient(circle, rgba(255,30,30,.13), transparent 45%);
      animation: backgroundGlow 7s ease-in-out infinite alternate;
      pointer-events: none;
    }

    @keyframes backgroundGlow {
      from { transform: translate(-8%, -5%) scale(1); }
    ...
    @keyframes logoGlow {
      from { text-shadow: 0 0 10px #ff2525, 0 0 25px #f00; }
      to { text-shadow: 0 0 15px #ff5656, 0 0 42px #f00, 0 0 70px rgba(255,0,0,.6); }
    }

    .menu-button {
      width: 52px;
      height: 52px;
      border: 1px solid rgba(255,75,75,.7);
      border-radius: 13px;
      background: rgba(17,20,34,.88);
      cursor: pointer;
      display: flex;
    ...
    .menu-button:hover {
      ...
      box-shadow: 0 0 24px rgba(255,40,40,.7);
    }
    ...
    .menu {
      ...
      padding: 12px;
      border-radius: 15px;
      background: rgba(14,17,29,.98);
      border: 1px solid rgba(255,60,60,.55);
      box-shadow: 0 0 25px rgba(255,30,30,.22);
      transform-origin: top right;
    }

    .menu.show { display: block; animation: menuOpen .28s ease both; }

    @keyframes menuOpen {
      from { opacity: 0; transform: scale(.88) translateY(-15px); }
    ...
    .menu a:hover {
      background: linear-gradient(135deg,#ff3636,#a90000);
    ...
    .server-box {
      ...
      box-shadow: 0 0 30px rgba(255,35,35,.2);
      backdrop-filter: blur(8px);
      animation: floatingBox 3.5s ease-in-out infinite;
    }
    ...
    .ip { font-size: 20px; font-weight: 700; word-break: break-word; }
    .port { margin-top: 7px; color: #b8b8b8; }
    .status { margin-top: 16px; font-weight: 600; }

    .online {
      color: #54ff85;
      text-shadow: 0 0 10px rgba(84,255,133,.6);
    ...
    .join-btn,.youtube-btn { background: linear-gradient(135deg,#ff2020,#b60000); border-color:#ff6464; }
    .discord-btn { background: linear-gradient(135deg,#6875ff,#3d48c7); border-color:#8b95ff; }

    section { padding: 90px 25px; text-align: center; }
    .dark-section { background: #0d101a; }

    .section-title {
      font-family: "Orbitron", sans-serif;
      font-size: clamp(28px,5vw,42px);
      letter-spacing: 2px;
      text-shadow: 0 0 14px rgba(255,45,45,.65);
    }

    .section-text { max-width:760px; margin:18px auto 42px; color:#bdbdbd; line-height:1.7; }
    ...
    .feature-card:hover,.rule-card:hover {
      ...
      border-color:#ff4444;
      box-shadow:0 0 25px rgba(255,35,35,.18);
    }

    .feature-card h3,.rule-card h3 { color:#ff4a4a; margin-bottom:12px; font-size:19px; }
    .feature-card p,.rule-card p { color:#c4c4c4; font-size:14px; line-height:1.6; }
    ...
    .owner-card {
      ...
      box-shadow:0 0 35px rgba(255,30,30,.17);
    }
    ...
    .owner-card h3 { font-family:"Orbitron",sans-serif; font-size:28px; }
    .owner-role { color:#ff4848; font-weight:700; margin:8px 0 15px; }
    .owner-card p { max-width:580px; margin:auto; color:#c9c9c9; line-height:1.7; }
    ...
    .player-count {
      ...
      font-size:62px;
      color:#58ff87;
      text-shadow:0 0 18px rgba(88,255,135,.55);
    }
    ...
    .leader-row:hover { background:rgba(255,50,50,.08); padding-left:28px; }
    .rank-number { color:#ff4c4c; font-weight:bold; }

    .reveal { opacity:0; transform:translateY(35px); transition:.7s ease; }
